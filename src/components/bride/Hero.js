  ...
  />
    ...
    <div className="relative z-20 max-w-4xl px-6 pt-12 md:pt-16 flex flex-col items-center">
        ...
        <motion.p
          ...
          className="text-gold-300 font-serif-royal text-sm md:text-base tracking-[0.25em] mb-6 uppercase"
        >
          {t.hero.familyIntro}
        </motion.p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-8 my-6 md:my-10">
          <motion.h2
            ...
            className="font-calligraphy-royal text-gold-500 text-6xl md:text-8xl drop-shadow-[0_2px_10px_rgba(212,175,55,0.4)]"
          >
           {t.hero.groom}
          </motion.h2>
...
>
  ...
  />
        ...
        <motion.p
          ...
          className="text-gold-100/90 text-xs md:text-sm tracking-[0.2em] max-w-xl mx-auto leading-relaxed uppercase mb-8"
        >
...
>
  <span className="text-gold-300 uppercase tracking-[0.35em] text-sm md:text-base font-serif-royal mb-6">
    Save The Date
  </span>
 ...
 <div className="relative w-[360px] md:w-[600px] h-[65px] md:h-[80px] flex items-center justify-center">
    <HeroScratchDate text={t.hero.date} theme="bride" />
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
         className="group relative -mt-3 px-8 py-3.5 rounded-full overflow-hidden border border-gold-500/40 text-gold-500 hover:text-maroon-900 bg-transparent hover:bg-gold-500 font-serif-royal text-xs md:text-sm tracking-[0.2em] cursor-pointer shadow-[0_0_15px_rgba(212,175,55,0.15)] transition-all duration-500 uppercase">
